...
import eu.darken.sdmse.deduplicator.databinding.DeduplicatorDetailsFragmentBinding
        ...
        ui.viewpager.apply {
            ...
            addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
                ...
                override fun onPageSelected(position: Int) {
                    ...
                    pagerAdapter.getFragment(ui.viewpager.currentItem)?.view?.findViewById<View>(eu.darken.sdmse.common.R.id.list)?.let {
        ...
        vm.state.observe2(ui) { state ->
            ...
            toolbar.menu.findItem(R.id.action_toggle_view_mode)?.apply {
                ...
                setIcon(
                    ...
                    else CommonR.drawable.ic_folder
                )
                setTitle(
