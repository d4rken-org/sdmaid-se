...
import eu.darken.sdmse.deduplicator.databinding.DeduplicatorClusterFragmentBinding
...
class ClusterFragment : Fragment3(R.layout.deduplicator_cluster_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        selectionTracker = installListSelection(
            ...
            toolbar = requireParentFragment().requireView().findViewById(eu.darken.sdmse.common.R.id.toolbar),
