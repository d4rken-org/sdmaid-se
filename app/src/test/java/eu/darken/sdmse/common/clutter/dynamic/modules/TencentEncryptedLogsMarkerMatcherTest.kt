...
class TencentEncryptedLogsMarkerMatcherTest {

    private val markerSource = TencentEncryptedLogsMarkerMatcher()
    ...
    companion object {
        private val BASEDIR = listOf("tencent", "wns", "EncryptLogs")
    }
}