...
import eu.darken.sdmse.databinding.DonateFragmentBinding

@AndroidEntryPoint
class DonateFragment : Fragment3(R.layout.donate_fragment) {

    override val vm: DonateViewModel by viewModels()
    override val ui: DonateFragmentBinding by viewBinding()
