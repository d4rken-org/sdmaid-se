...
class DataAppPrivateModule @Inject constructor(
    ...
    override suspend fun secondPass(firstPass: Collection<StorageArea>): Collection<StorageArea> {
        ...
        return firstPass
            ...
            .mapNotNull { area ->
                val path = LocalPath.build(area.path as LocalPath, "app-private")
                ...
                StorageArea(
                    type = StorageArea.Type.APP_APP_PRIVATE,
                    path = path,
    ...
    companion object {
        val TAG: String = logTag("StorageArea", "Module", "DataAppPrivate")
    }
}