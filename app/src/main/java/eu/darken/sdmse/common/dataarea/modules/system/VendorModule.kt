...
// */
//internal class VendorModule(storageFactory: StorageFactory) : StorageFactoryModule(storageFactory) {
...
//
//    companion object {
//        val TAG: String = App.logTag("Storage", "Module", "Vendor")
//    }
//}