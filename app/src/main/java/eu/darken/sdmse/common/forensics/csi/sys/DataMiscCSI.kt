...
@Reusable
class DataMiscCSI @Inject constructor(
    private val areaManager: DataAreaManager,
) : LocalCSIProcessor {
    override suspend fun hasJurisdiction(type: DataArea.Type): Boolean = type == DataArea.Type.DATA_MISC
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: DataMiscCSI): CSIProcessor
    }

    companion object {
        val TAG: String = logTag("CSI", "Data", "Misc")
    }
}