...
import eu.darken.sdmse.common.forensics.csi.privs.CSIPrivateData
...
@Reusable
class CSIData @Inject constructor(
    ...
    private suspend fun getBadMatches(): Collection<String> = cacheLock.withLock {
        ...
        val part2 = dataAreas
            ...
            .map { LocalPath.build(it.path.path, CSIPrivateData.DEFAULT_DIR).path + File.separator }
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: CSIData): CSIProcessor
    }
