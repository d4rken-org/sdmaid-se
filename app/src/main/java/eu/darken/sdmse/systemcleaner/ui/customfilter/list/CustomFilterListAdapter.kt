...
class CustomFilterListAdapter @Inject constructor() :
    ModularAdapter<CustomFilterListAdapter.BaseVH<CustomFilterListAdapter.Item, ViewBinding>>(),
    HasAsyncDiffer<CustomFilterListAdapter.Item> {
