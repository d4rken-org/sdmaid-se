...
class LiveSearchListAdapter @Inject constructor() :
    ModularAdapter<LiveSearchListAdapter.BaseVH<LiveSearchListAdapter.Item, ViewBinding>>(),
    HasAsyncDiffer<LiveSearchListAdapter.Item> {
