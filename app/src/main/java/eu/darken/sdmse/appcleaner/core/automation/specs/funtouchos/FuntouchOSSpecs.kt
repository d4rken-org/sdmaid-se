...
@Reusable
class FuntouchOSSpecs @Inject constructor(
    private val ipcFunnel: IPCFunnel,
    private val deviceDetective: DeviceDetective,
    private val funtouchLabels: FuntouchOSLabels,
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        ...
        if (romType == RomType.FUNTOUCHOS) return true
        if (romType != RomType.AUTO) return false

        return deviceDetective.getROMType() == RomType.FUNTOUCHOS
    }
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: FuntouchOSSpecs): AppCleanerSpecGenerator
    }
