...
@Reusable
open class AOSP14to28Specs @Inject constructor(
    ipcFunnel: IPCFunnel,
    @ApplicationContext private val context: Context,
    private val deviceDetective: DeviceDetective,
) : AOSPBaseSpecs(ipcFunnel, context) {
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean = !hasApiLevel(29) && !deviceDetective.isAndroidTV()
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: AOSP14to28Specs): AutomationStepGenerator
    }

    companion object {
        val TAG: String = logTag("AppCleaner", "Automation", "AOSP14to28Specs")
    }
}