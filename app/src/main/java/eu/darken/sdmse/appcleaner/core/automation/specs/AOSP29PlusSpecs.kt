...
@Reusable
open class AOSP29PlusSpecs @Inject constructor(
    ipcFunnel: IPCFunnel,
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean =
        hasApiLevel(29) && !deviceDetective.isAndroidTV()
    ...
    override fun getStorageEntryLabels(lang: String, script: String): Collection<String> {
        context.get3rdPartyString(AOSP_SETTINGS_PKG, "storage_settings_for_app")?.let {
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: AOSP29PlusSpecs): AutomationStepGenerator
    }

    companion object {
        val TAG: String = logTag("AppCleaner", "Automation", "AOSP29PlusSpecs")
    }
