...
class HonorSpecs @Inject constructor(
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        ...
        if (romType == RomType.HONOR) return true
        if (romType != RomType.AUTO) return false

        return deviceDetective.getROMType() == RomType.HONOR
    }
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: HonorSpecs): AppCleanerSpecGenerator
    }
