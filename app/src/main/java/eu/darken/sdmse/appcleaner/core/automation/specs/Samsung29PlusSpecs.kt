...
@Reusable
class Samsung29PlusSpecs @Inject constructor(
    ipcFunnel: IPCFunnel,
    @ApplicationContext private val context: Context,
    private val deviceDetective: DeviceDetective,
) : Samsung14To28Specs(ipcFunnel, context, deviceDetective) {
    ...
    // Samsung One UI 2.0 (Android 10) still uses pre AOSP28 labels
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: Samsung29PlusSpecs): AutomationStepGenerator
    }

    companion object {
        val TAG: String = logTag("AppCleaner", "Automation", "Samsung29PlusSpecs")
    }
}