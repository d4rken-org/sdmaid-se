...
import eu.darken.sdmse.databinding.SqueezerZoomablePreviewDialogBinding

class ZoomablePreviewDialog : DialogFragment() {

    private var _binding: SqueezerZoomablePreviewDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = SqueezerZoomablePreviewDialogBinding.inflate(inflater, container, false)
        return binding.root
    }
